      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Have questions about BuyAgain? We're here to help. Get in touch with our support team.
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">support@buyagain.ng</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Need help setting up your account? Check our getting started guide.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Having trouble with the platform? Our team can assist.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Questions about plans, payments, or billing? We're here to help.
                    </p>
                  </div>
                </div>
              </CardContent>
